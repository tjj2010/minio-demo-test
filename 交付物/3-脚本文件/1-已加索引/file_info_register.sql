...
CREATE TABLE `file_info_register` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unq_index_newFileName` (`new_file_name`),
  KEY `index_businessId_moduleCode` (`business_id`,`module_code`),
  KEY `index_queryCondition` (`original_file_name`,`business_id`,`module_code`,`upload_operator`,`upload_time`)
...
INSERT INTO `file_info_register` VALUES ('8', '新建文本文档 (2).txt', 'salt_1625636843160_2021-07-07_197_新建文本文档 (2).txt', 'module01', 'businessId01', '001', null, '0', '.txt', '2021-07-07 13:47:23', null, '00', '2021-07-07 13:47:23', '2021-07-07 13:47:23');
